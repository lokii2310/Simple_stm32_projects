...
int main(void)
{
	...
	GpioLed.GPIO_PinConig.GPIO_PinNumber = GPIO_PIN_NO_11;
	...
	GpioBtn.GPIO_PinConig.GPIO_PinNumber = GPIO_PIN_NO_12;
	GpioBtn.GPIO_PinConig.GPIO_PinMode = GPIO_MODE_IN;
	GpioBtn.GPIO_PinConig.GPIO_PinSpeed = GPIO_SPEED_FAST;
	GpioBtn.GPIO_PinConig.GPIO_PinPuPdContol = GPIO_PIN_PU;
